...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 5 and max is 9' do
      ...
      it 'returns 7' do
        expect(game_5_9.make_guess).to eql(7)
      end
    end
    ...
    context 'when min is 8 and max is 9' do
      ...
      it 'returns 8' do
        expect(subject.make_guess).to eql(8)
      end
    end
    ...
    context 'when min is 0 and max is 3' do
      ...
      it 'returns 1' do
        midpoint = game_0_3.make_guess
        expect(midpoint).to eql(1)
      end
    end
    ...
    context 'when min and max both equal 3' do
      ...
      it 'returns 3' do
        expect(game_3_3.make_guess).to eql(3)
      end
    end
  end
  ...
  describe '#game_over?' do
    let(:random_number_to_guess) { double('random_number', value: 8) }
    ...
    context 'when guess and random_number are equal' do
      ...
      subject(:game_correct_guess) { described_class.new(0, 9, random_number_to_guess, 8) }
      ...
      it 'is game over' do
        expect(game_correct_guess.game_over?).to be true
      end
    end
    ...
    context 'when guess and random_number are not equal' do
      subject(:game_incorrect_guess) { described_class.new(0, 9, random_number_to_guess, 6)}

      it 'is not game over' do
        expect(game_incorrect_guess.game_over?).to be false
      end
    end
  end
  ...
  describe '#update_range' do
    ...
    context 'when the guess is 7, min=5, and max=8' do
      ...
      let(:game_answer) { double('random_number', value: 8)}
      subject(:edge_game) { described_class.new(5, 8, game_answer, 7)}
      ...
      it 'updates min to the same value as max' do
        expect(edge_game.min).to eql(edge_game.max)
      end
